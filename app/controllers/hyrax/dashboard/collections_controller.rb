  ...
  module Dashboard
    ...
    class CollectionsController < Hyrax::My::CollectionsController
      ...
      def create
        ...
        # Assumes collections without a collection_type_gid were migrated from older versions.  Set it to the default User Collection type.
      ...
      private
        ...
        def set_default_permissions
          additional_grants = @participants # Grants converted from older versions where share was edit or read access instead of managers, depositors, and viewers
